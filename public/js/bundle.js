...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamVzdXNnYXJ6YSIsImEiOiJjazF0bHI5OXMwczM0M2JwcXR0NDQ1ODYxIn0.RIkp6YoABuEcyFg-qMYFxA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jesusgarza/ck1tm1h0160081clh5235e4m3',
    scrollZoom: false // center: [-118.116579, 34.111692],
    // zoom: 10,
    // interactive: false
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.default)('error', 'Error logging out! Try again.');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; // console.log(name, email);
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.default)('success', "".concat(type.toUpperCase(), " updated successfully!"));
            }
...
var stripe = Stripe('pk_test_cOlqWQa0HxRJ5HP0tKAjWGCJ00pb9mnA6v');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); // uses the same format a form would use if the encoding type were set to "multipart/form-data"
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "50731" + '/');
